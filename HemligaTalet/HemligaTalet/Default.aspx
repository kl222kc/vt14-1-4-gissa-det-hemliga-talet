...
<body>
    ...
    <div>
        ...
        <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Talet måste vara ett heltal inom 1-100" CssClass="error" ControlToValidate="GuessTextBox" Text="*" Type="Double" MaximumValue="100" MinimumValue="1" Display="Dynamic"></asp:RangeValidator>
